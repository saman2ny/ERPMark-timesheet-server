                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Leavestatus</a></li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Leave status</h4>
                                    </div>
                                </div>
                            </div>
                            <!-- end page title -->
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">Leave status list</h4>
                                            ...
                                            <table id="example" class="table table-striped dt-responsive nowrap">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>leavetype</th>
                                                        <th>Message</th>
                                                        <th>approvelstatus</th>
                                                        <th>Action</th>
                                                    </tr>
                                                </thead>

                                                <tbody>
                                                    <?php foreach ($leavestatuslist as $key=>$value):?>   
                                                        <tr>
                                                            <td>
                                                                <?php echo $leavestatuslist[$key]['employeeid'];?>
                                                            </td>
                                                            <td>
																<?php 
																	$sampleDate = $leavestatuslist[$key]['date'];
																	$convertdate = date("d-m-Y", strtotime($sampleDate));
																?>
                                                                <?php echo $convertdate;?>
                                                            </td>
                                                            <td>
                                                                <?php echo $leavestatuslist[$key]['firstname'];?>
                                                            </td>
                                                        
                                                            <td>
                                                                <?php echo $leavestatuslist[$key]['noofleave'];?>
                                                            </td>
                                                            <td>
																<?php 
																	$sampleDate = $leavestatuslist[$key]['fromdate'];
                                                            ...
                                                            <td>
																<?php 
																	$sampleDate = $leavestatuslist[$key]['todate'];
																	$convertenddate = date("d-m-Y", strtotime($sampleDate));
																?>
                                                                <?php echo $convertenddate;?>
                                                            </td>
                                                            <td>
                                                                <?php echo $leavestatuslist[$key]['leavetype'];?>
                                                            </td>
                                                            <td>
                                                                <?php echo $leavestatuslist[$key]['message'];?>
                                                            </td>
                                                            <td>
                                                                <?php echo $leavestatuslist[$key]['approvelstatus'];?>
                                                            </td>
                                                           
                                                              <td>
                                            <a href="<?php echo base_url('Branch/updateleave/'.base64_encode($leavestatuslist[$key]['id']).'');?>">Update</a>
