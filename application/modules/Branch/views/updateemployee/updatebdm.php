        ...
        <div id="wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <?php echo form_open('Branch/updatebdm/', 'class="form-horizontal" role="form" id="updatebdm"'); ?>
...
<!--
        <div class="form-group row">
            <label for="selectband" class="col-md-3 control-label">Select Band</label>
            <div class="col-md-9">
                <select  class="form-control" id="selectband" placeholder="Select Band" name="selectband" onchange="showDiv('hidden_div', this)">
                    <option value="Band1">Band 1</option>
                    <option value="Band1">Band 2</option>
                    <option value="Band1">Band 3</option>
                    <option value="Band1">Band 4</option>
                    <option value="Band1">Band 5</option>
                    <option value="Band1">Band 6</option>
                    <option value="Band1">Band 7</option>
                    <option value="Band1">Band 8</option>
                    <option value="Band1">Band 9</option>
                    <option value="Band1">Band 10</option>
                </select>
            </div>
        </div>  
...
-->
                           ...
                           <div class="form-group row">
                                <label for="reportingmanager" class="col-md-3 control-label">Reporting Manager</label>
                                <div class="col-md-9">
                                    <select  class="form-control" id="reportingmanager" placeholder="Reporting Manager" name="reportingmanager">
                                        <option>Manager 1</option>
                                        <option>Manager 2</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 sm-m-t-10" id="input_align_top">
                        <input  type="number" class="form-control date" id="homephoneno" name="homephoneno" placeholder="Home Phone No"  value="<?php echo $employeeUpdateListing['homephoneno'];?>">
                    </div>
                </div>
            </div>
        </div>
