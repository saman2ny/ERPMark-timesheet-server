    ...
    <body>
		...
		<?php endif; ?>
                        ...
                        <td><?php echo $employee[$key]['visaexpirydate'];?></td>
						 ...
						 <td><a href="<?php echo base_url('Branch/updateemployee/'.base64_encode($employee[$key]['id']).'');?>">Update</a></td>
