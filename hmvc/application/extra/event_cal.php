...
<!--
                                                <a href="#" data-toggle="modal" data-target="#add-category" class="btn btn-lg font-16 btn-primary btn-block  ">
                                                    <i class="mdi mdi-plus-circle-outline"></i> Create  Leave
                                                </a>
-->
                                                
                                                
        <a href="<?php echo base_url();?>branch/addleave" class="btn btn-lg font-16 btn-primary btn-block"> <i class="mdi mdi-plus-circle-outline"></i>Create  Leave</a>

        <div id="external-events" class="m-t-20">
            <br>
            <p class="text-muted"></p>

        <?php foreach ($leavelistbox as $key=>$value):?>
            <div class="external-event bg-danger" data-class="bg-danger"><i class="mdi mdi-checkbox-blank-circle mr-2 vertical-middle"></i><?php echo $leavelistbox[$key]['name'];?></div>
        <?php endforeach;?>      
...
-->
                                ...
                                <!-- Add New Event MODAL -->
                                <div class="modal fade" id="event-modalssss" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="text-right p-3">
                                                ...
                                                <button type="button" class="btn btn-success save-event  ">Submit</button>
                                            ...
                                            <div class="modal-body p-3">
                                                <form>
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control form-white" placeholder="Select Date" type="date" id="selectdate" name="selectdate"/>
                                                    </div>  
