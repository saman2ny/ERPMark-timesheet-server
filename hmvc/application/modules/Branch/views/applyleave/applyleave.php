                                        ...
                                        <div class="container" id="form_padding">
                                            ...
                                            <?php if($this->session->flashdata('msg')): ?>
                                                ...
                                                <?php endif; ?>
                                                    ...
                                                    <?php echo form_open('Bdm/insertApplyLeave/', 'class="form-horizontal" role="form" id="insertapplyleave"'); ?>
                                                        ...
                                                        <div class="form-group row ">
                                                            <label class="col-md-3 control-label">BDM Name / Branch</label>
                                                            <div class="col-md-9">
                                                                <div class="row">
                                                                    <div class="col-md-9 sm-m-t-10" id="input_align_top">
                                                                        <input id="end-date" type="text" class="form-control" name="firstname" placeholder="bdmname" value="<?php echo $employee['firstname']?>" readonly>
                                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="noofleave" class="col-md-3 control-label">No of Days</label>
                                                            <div class="col-md-9">
                                                                <input type="number" class="form-control" id="noofleave" min="0" placeholder="No of Leave" name="noofleave">
                                                            </div>
                                                        </div>

                                                        <div class="form-group row">
                                                            <label class="col-md-3 control-label">From / To Date</label>
                                                            <div class="col-md-9">
                                                                <div class="row">
                                                                    <div class="col-md-5" id="input_align_top">
                                                                        <input id="start-date" type="date" class="form-control date" name="fromdate"  placeholder="From Date">
                                                                    </div>
                                                                    <div class="col-md-5 sm-m-t-10" id="input_align_top">
                                                                        <input id="end-date" type="date" class="form-control date" name="todate"  placeholder="To Date">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-control" id="fname" placeholder="Type Of Leave" name="leavetype">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea class="form-control" id="name" placeholder="Message" name="message"></textarea>
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="row">
