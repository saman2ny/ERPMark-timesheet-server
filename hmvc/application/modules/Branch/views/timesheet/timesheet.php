                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title"> <a href="<?php echo base_url();?>Bdm/inserttimesheet">Insert NEW TIME SHEET</a></h4>
                                    </div>
                                </div>
                            </div>
                            <!-- end page title -->
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <table id="example" class="table table-striped dt-responsive nowrap">
                                                ...
                                                <tbody>
                                                    <?php foreach ($timesheetlist as $key=>$value):?>   
                                                        <tr>
                                                            <td>
                                                                <?php echo $timesheetlist[$key]['id'];?>
                                                            </td> <td>
                                                                <?php echo $timesheetlist[$key]['employeeid'];?>
                                                            </td> 
                                                            <td>
                                                                <?php echo $timesheetlist[$key]['empname'];?>
                                                            </td>
                                                            <td>
																<?php 
																	$sampleDate = $timesheetlist[$key]['date'];
                                                            ...
                                                            <td>
                                                                <?php echo $timesheetlist[$key]['project'];?>
                                                            </td>
                                                           
                                                            <td>
                                                                <?php echo $timesheetlist[$key]['assignedhours'];?>
                                                            </td>
                                                            <td>
                                                                <?php echo $timesheetlist[$key]['hours'];?>
                                                            </td>
                                                            <td>
                                                                <?php echo $timesheetlist[$key]['description'];?>
                                                            </td>
                                                           
                                                              <td>
                                            <a href="<?php echo base_url('Branch/updatetimesheet/'.base64_encode($timesheetlist[$key]['id']).'');?>">Update</a>
